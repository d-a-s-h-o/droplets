...
echo "<h1 style=\"text-align:center;\">Hello World.</h1><br><p>Wondering what to do now? Why not upload your web files at <a href=\"http://".$file."\" target=\"_blank\">".$file."</a>, your own self-hosted file manager where you can edit your web directory, create new files with a web-based styled texteditor, and much more?<br>
